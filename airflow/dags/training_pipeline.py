...
with DAG(
    ...
    def data_ingestion(**kwargs):
        ti = kwargs["ti"]
        train_data_path,test_data_path=training_pipeline.start_data_ingestion('notebooks/data/train.csv', 'notebooks/data/cubic_zirconia.csv')
    ...
    def model_trainer(**kwargs):
        ...
        training_pipeline.start_model_training(train_arr)
